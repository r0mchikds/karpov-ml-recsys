# 🧠 Обучение моделей рекомендаций (TF-IDF и BERT)
...
| Модель | Train ROC-AUC | Test ROC-AUC | HitRate@5 |
|--------|----------------|--------------|------------|
| TF-IDF (контроль) | 0.6896 | 0.6426 | **0.583** |
| BERT (тест) | 0.6957 | 0.6583 | **0.597** |
...
> которая выросла на **1.02%**, превысив бейзлайн (**0.57**) в обеих группах.
